...
import com.bshdjk.cloud.uc.api.dto.AuthAccountDTO;
import com.bshdjk.cloud.uc.api.vo.AuthAccountVO;
import com.bshdjk.cloud.uc.api.vo.TokenInfoVO;
 ...
 * @date 2020/9/22
 */
@FeignClient(value = "mallbshdjk-auth",contextId ="account")
